<?php require_once "function/conn.php"; ?>
    ...
    <main>
        ...
        <article id="container-content">
            ...
            <header id="header-section">
                <a href="cad-user.php"><input type="button" value="Cadastrar" id="cad-button"></a>
                <div id="line"></div>
            </header>
            <!--Header ================================================================================-->
            ...
            <section id="container-post">
                ...
                <div class="box-info " style="margin: 10px 0 0 0;">
                    <div class="name-separate">Usuário:</div>
                ...
                <div class="box-info" style="margin-top: 5px;">
                    <div class="name-separate">
                        <a href="../pages/noticia.html" style="color: black;"><?php echo $row['name'] ?></a>
                    </div>
                    
                    <!--Update ========================================================================-->
                    <div class="icon-separate">
                        <a href="cad-user.php?func=update&id=<?php echo $row['id'] ?>" style="color: black;">
                    ...
                    <!--Delete ========================================================================-->
                    <div class="icon-separate">
                        <a href="function/user.php?func=delete&id=<?php echo $row['id'] ?>" style="color: black;">
