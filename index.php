...
<body>
    ...
    <header>
        <div id="container-header">
            ...
            <form action="pages/search.php" method="get" id="form-search">
        ...
        <nav>
            ...
            <ul>
                ...
                ?>
                    <li>
                        <a href="pages/search.php?search=<?php echo $cat['category'] ?>" style="text-transform: uppercase;">
    ...
    <footer>
        <div id="container-footer">
            ...
            <div id="container-links">
                <h4 style="color: white; margin-bottom: 5px;">Links:</h4>
                <a href=""><p>Denuncie</p></a>
                <a href=""><p>Imprensa</p></a>
                <a href=""><p>Fale Conosco</p></a>
                <a href=""><p>Segurança e Privacidade</p></a>
                <a href=""><p>Trabalhe Conosco</p></a>
                <a href=""><p>Publicidade</p></a>
            </div>
            <div id="container-about">
                <h4>Sobre:</h4>
                <p style="margin-top: 5px;">Texto sobre alguma coisa escrita aqui
                    so para demarcar a area do sobre no rodape
                    aqui terá algo em breve.
                </p>
            </div>
